...
export default function ProfileCard({
  ...
  useEffect(() => {
    if (!enableTilt || !animationHandlers) return undefined;
    const card = cardRef.current;
    const wrap = wrapRef.current;
    if (!card || !wrap) return undefined;
  ...
  }, [animationHandlers, enableTilt, handlePointerEnter, handlePointerLeave, handlePointerMove]);
      ...
      <section ref={cardRef} className="pc-card">
        <div className="pc-inside">
          ...
          <div className="pc-content pc-avatar-content">
            <img className="avatar" src={avatarUrl} alt="Divyakanth profile" loading="lazy" />
            {showUserInfo && (
